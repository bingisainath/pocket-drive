...
export function Modal({ label, onClose, children }: { label: string; onClose: () => void; children: ReactNode }) {
  ...
  return createPortal(
    ...
    >
      ...
      />
      <div className="relative max-h-[90dvh] w-full animate-sheet-up overflow-y-auto rounded-t-3xl bg-white pb-[env(safe-area-inset-bottom)] shadow-2xl sm:max-w-md sm:rounded-3xl sm:pb-0 dark:bg-slate-900">
